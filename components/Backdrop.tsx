 ...
 */
export function Backdrop({ width, height }: Props) {
      ...
      <Svg width={width} height={height} style={StyleSheet.absoluteFill}>
        <Defs>
          <RadialGradient id="violet" cx="50%" cy="50%" r="50%">
            <Stop offset="0" stopColor={palette.nebulaViolet} stopOpacity={0.55} />
            <Stop offset="1" stopColor={palette.nebulaViolet} stopOpacity={0} />
          </RadialGradient>
          <RadialGradient id="teal" cx="50%" cy="50%" r="50%">
            <Stop offset="0" stopColor={palette.nebulaTeal} stopOpacity={0.45} />
