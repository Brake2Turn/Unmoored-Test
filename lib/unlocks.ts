 ...
 *
 * Nothing calls `unlockShip` yet — there is no gameplay to trigger it. It is
 * here so that when a run can actually end, awarding a ship is one call and
 * the rest of the app already reacts.
 */
